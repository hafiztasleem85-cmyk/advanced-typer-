...
local function readConfig()
    ...
    return {translate = false, details = {}, micIndex = 0, targetIndex = 2, offlineIndex = 0, customCommands = {"name", "mobile", "address", "email"}, dictionary = {}, dictionaryEnabled = true, pinnedLanguages = {}}
end
